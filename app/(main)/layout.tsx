...
export default function MainLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex flex-col min-h-screen max-w-lg mx-auto relative" style={{ background: '#080c14' }}>
      ...
      {/* Top bar — notification bell + settings gear */}
      <div
        className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-lg z-50 flex items-center justify-end px-4 py-2 gap-1"
      ...
      {/* pt-14 = top bar height, pb-20 = bottom nav height clearance */}

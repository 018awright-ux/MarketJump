          ...
          resetSent ? (
            ...
            <>
              <button
                ...
                className="flex items-center gap-1.5 text-[#6b7280] text-sm mb-5 hover:text-white transition-colors"
              >
              ...
              <h1 className="text-xl font-bold mb-2 text-white">Reset password</h1>
              <p className="text-[#6b7280] text-sm mb-5">Enter your email and we&apos;ll send you a reset link.</p>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="block text-xs text-[#6b7280] uppercase tracking-wider">Password</label>
                  <button
                    type="button"

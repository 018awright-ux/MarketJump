...
const MOCK_2024_RESULTS: GoToCallerResult = {
  ...
  callers: [
    ...
    { id: '17', username: 'small_cap_sal',  brand_name: 'SmallCapSal',   brand_avatar_url: null, level: 'shark',  followers: 980,  accuracy: 59.7, total_predictions: 291, top_call: 'Microcap biotech catalyst that 3x'd' },
